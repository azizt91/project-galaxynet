                ...
                <div class="flex items-start justify-between">
                    <div class="flex-1">
                        <div class="flex items-center gap-2 mb-1">
                            <h3 class="text-[#1b1510] text-lg font-bold">${pkg.package_name}</h3>
                        ...
                        <div class="flex items-center gap-2 mb-2">
                            <span class="inline-flex items-center gap-1 bg-orange-100 text-purple-700 px-3 py-1 rounded-full text-xs font-semibold">
                        ...
                        <p class="text-[#1b1510] text-2xl font-bold text-green-600">${formatter.format(pkg.price)}</p>
