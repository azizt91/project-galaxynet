...
_Pesan otomatis dari aplikasi GALAXY.NET_`;
    }
            ...
            return `
                <div class="flex items-start gap-3 bg-white px-4 py-3 rounded-lg mb-3 border border-[#e7edf3]">
                    ...
                    <div class="flex flex-col flex-1">
                        ...
                        <p class="text-[#1b1510] text-sm font-normal leading-normal" id="${uniqueId}">${method.account_number}</p>
